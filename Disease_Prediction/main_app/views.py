...
def give_suggestions(request, consultation_id):
    ...
    return render(request, 'give_suggestions.html', context)





def consultation_view1(request, consultation_id):
    consultation_obj = get_object_or_404(consultation, id=consultation_id)
    
    if request.user.is_authenticated and request.user.patient.is_patient:
        patient = request.user.patient
        return render(request, 'consultation/consultation.html', {'consultation': consultation_obj, 'patient': patient})
