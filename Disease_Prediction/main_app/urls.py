...
urlpatterns = [
    ...
    path('consultation/<int:consultation_id>/give-suggestions/', views.give_suggestions, name='give_suggestions'),

    path('consultationview1/<int:consultation_id>/', views.consultation_view1, name='consultation_view1'),
